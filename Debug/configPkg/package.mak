...
ti.targets.arm.elf.M3.rootDir ?= C:/ti/ccsv7/tools/compiler/ti-cgt-arm_18.1.1.LTS
...
.dlls,em3 .dlls: controlPrincipal.pem3

-include package/cfg/controlPrincipal_pem3.mak
-include package/cfg/controlPrincipal_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/controlPrincipal_pem3.dep
endif
controlPrincipal.pem3: package/cfg/controlPrincipal_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
controlPrincipal.pem3 package/cfg/controlPrincipal_pem3.c: .libraries,em3
endif

package/cfg/controlPrincipal_pem3.c package/cfg/controlPrincipal_pem3.h package/cfg/controlPrincipal_pem3.xdl: override _PROG_NAME := controlPrincipal.xem3
package/cfg/controlPrincipal_pem3.c: package/cfg/controlPrincipal_pem3.cfg
package/cfg/controlPrincipal_pem3.xdc.inc: package/cfg/controlPrincipal_pem3.xdl
package/cfg/controlPrincipal_pem3.xdl package/cfg/controlPrincipal_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/controlPrincipal_pem3.cfg
	-$(RM) package/cfg/controlPrincipal_pem3.dep
	-$(RM) package/cfg/controlPrincipal_pem3.c
	-$(RM) package/cfg/controlPrincipal_pem3.xdc.inc

clean,em3::
	-$(RM) controlPrincipal.pem3
.executables,em3 .executables: controlPrincipal.xem3

controlPrincipal.xem3: |controlPrincipal.pem3

-include package/cfg/controlPrincipal.xem3.mak
controlPrincipal.xem3: package/cfg/controlPrincipal_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/controlPrincipal_pem3.oem3   package/cfg/controlPrincipal_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
controlPrincipal.xem3: export C_DIR=
controlPrincipal.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
controlPrincipal.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

controlPrincipal.test test,em3 test: controlPrincipal.xem3.test

controlPrincipal.xem3.test:: controlPrincipal.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 controlPrincipal.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.controlPrincipal.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,controlPrincipal.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) controlPrincipal.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
controlPrincipal_pem3.oem3,copy : package/cfg/controlPrincipal_pem3.oem3
controlPrincipal_pem3.sem3,copy : package/cfg/controlPrincipal_pem3.sem3
